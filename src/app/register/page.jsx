        ...
        <div className="flex h-screen items-center justify-center">
            <div className="w-full md:w-2/5 bg-white flex items-center justify-center p-8">
                <div className="w-full max-w-md">
                    <h1 className="text-4xl text-[#6DC700] mb-2" style={{ fontFamily: "'Happy Monkey', cursive" }}>Sign Up</h1>
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="flex gap-3">
                            <button type="button" className="flex-1 flex items-center justify-center gap-2 bg-[#9E8D6E] text-white py-3 rounded-lg hover:bg-amber-800 transition-colors">
            ...
            <div className="hidden md:block lg:block max-w-2xl md:max-w-115 lg:max-w-xl lg:pt-1 0 md:pt-60">
