    ...
    return (
        <div className="bg-white/80 backdrop-blur-sm p-6 rounded-3xl shadow-xl border border-white/20 hover:shadow-2xl transition-all duration-300">
          ...
          <div className="space-y-3 max-h-96 overflow-y-auto pr-2">
            {[
              { nama: "Ahmad Rizki", buku: "Clean Code", tanggal: "20 Nov 2024", color: "bg-blue-500" },
              { nama: "Siti Nurhaliza", buku: "The Pragmatic Programmer", tanggal: "19 Nov 2024", color: "bg-purple-500" },
              { nama: "Budi Santoso", buku: "Design Patterns", tanggal: "18 Nov 2024", color: "bg-green-500" }
            ].map((item, index) => (
              <div 
                key={index} 
