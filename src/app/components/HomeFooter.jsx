        ...
        <section>
            <div className="flex border bg-[#ECF4E8] rounded-xl m-4 sm:m-10 gap-3 flex-col justify-center items-center p-4 sm:p-6">      
                <div className="flex flex-wrap text-black gap-3 sm:gap-5 justify-center" style={{ fontFamily: "'Hanken Grotesk', sans-serif" }}>
                    <h1 className="hover:underline text-sm sm:text-base">FAQ</h1>
                    <h1 className="hover:underline text-sm sm:text-base">Kebijakan Privasi</h1>
                    <h1 className="hover:underline text-sm sm:text-base">Bantuan</h1>
                    <h1 className="hover:underline text-sm sm:text-base">Tentang Kami</h1>
                </div>
